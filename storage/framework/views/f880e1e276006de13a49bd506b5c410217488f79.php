            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a download href="<?php echo e('stock_count/'.$stock_count->initial_file); ?>" title="<?php echo e(trans('file.Download')); ?>"><i class="dripicons-copy"></i></a>
                    </td>
                    <td class="text-center">
                        <?php if($stock_count->final_file): ?>
                        <a download href="<?php echo e('stock_count/'.$stock_count->final_file); ?>" title="<?php echo e(trans('file.Download')); ?>"><i class="dripicons-copy"></i></a>
                        <?php endif; ?>
                    </td>
                    <td>
                        <?php if($stock_count->final_file): ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\mis doc\proyecto 11\erp_pos_full\erp_pos\resources\views/stock_count/index.blade.php ENDPATH**/ ?>